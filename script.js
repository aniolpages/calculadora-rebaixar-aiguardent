...
function novesDades() {
    ...
    document.getElementById("f_a").innerHTML = e + " ml", document.getElementById("f_s").innerHTML = n + " g", document.getElementById("f_v").innerHTML = "Per aconseguir un volum de " + t + " ml a una graduació de " + i + "%. Recomanem utilitzar aigua de mineralització molt dèbil. Per minimitzar l'enterboliment de la ratafia, afegiu l'aiguardent sobre el xarop.", 1 == i1 && 1 == i2 && 1 == i3 && 1 == i4 && 0 == fet && (fet = !0, document.getElementById("r").style.display = "block", document.getElementById("t").style.height = Math.floor(document.getElementById("t").offsetHeight + document.getElementById("r").offsetHeight) + "px", setTimeout(function() {
